    ...
    return (
        <div className="flex flex-row justify-center ny-6">
            <div className="flex flex-row w-e/4 items-center justify-center space-x-4">
                <input type="text" className="text-xl font-light p-2 w-full shadow-xl focus:outline-none capitalize placeholder:lowercase" placeholder="Search a city..." value={inputValue}
