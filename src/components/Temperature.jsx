...
function Temperature({ weather: { temp, feels_like, temp_max, temp_min, humidity, localSunrise, localSunset, description, icon, speed }, unit }) {
    return (
        <div>
            <div className="flex items-center justify-center py-3 text-xl text-white text-2xl bhy capitalize width-100">
                {description}
            </div>
            ...
            <div className="flex flex-row item-center justify-center space-x-2 text-white text-sm font-light pt-4" id={styles.responsiveFull}>
                <UilTemperature />
            ...
            <div className=" flex-row item-center justify-center space-x-2 text-white text-sm font-light pt-4" id={styles.responsive740}>
                <UilTemperature />
                <p>Feels Like: <span className="font-medium">{`${unit === "imperial" ? `${feels_like}°F` : `${feels_like}°C`}`}</span></p>
                <p>|</p>
                <UilTear />
            ...
            <div className=" flex-row item-center justify-center space-x-2 text-white text-sm font-light pt-4" id={styles.responsive7402}>
                <UilArrowUp />
                <p>High: <span className="font-medium">{unit === "imperial" ? `${temp_max}°F` : `${temp_max}°C`}</span></p>
                <p>|</p>
                <UilArrowDown />
            ...
            <div className="flex flex-row item-center justify-center space-x-2 text-white text-sm font-light pt-4">
                <UilSun />
